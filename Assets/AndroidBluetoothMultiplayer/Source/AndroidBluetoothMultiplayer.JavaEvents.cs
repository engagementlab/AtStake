...
namespace LostPolygon.AndroidBluetoothMultiplayer {
    public sealed partial class AndroidBluetoothMultiplayer {
        ...
        private void JavaConnectedToServerHandler(string deviceInfoString) {
        ...
        // Fired when Bluetooth client failed to connect to the Bluetooth server
        // Provides BluetoothDevice of server device
        private void JavaConnectionToServerFailedHandler(string deviceInfoString) {
        ...
        private void JavaDisconnectedFromServerHandler(string deviceInfoString) {
        ...
        private void JavaClientConnectedHandler(string deviceInfoString) {
        ...
        private void JavaClientDisconnectedHandler(string deviceInfoString) {
        ...
        private void JavaDevicePickedHandler(string deviceInfoString) {
        ...
        private void JavaDeviceDiscoveredHandler(string deviceInfoString) {
