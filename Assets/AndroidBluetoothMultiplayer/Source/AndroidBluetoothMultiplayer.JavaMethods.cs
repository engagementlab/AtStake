...
namespace LostPolygon.AndroidBluetoothMultiplayer {
    ...
    public sealed partial class AndroidBluetoothMultiplayer {
        /// <summary>
        /// The delimiter used to separate serialized data from Java plugin.
        /// </summary>
        internal const string kDataDelimiter = "~~~#$%~~~";

        /// <summary>
        /// Default Bluetooth address.
        /// </summary>
        internal const string kZeroBluetoothAddress = "00:00:00:00:00:00";
